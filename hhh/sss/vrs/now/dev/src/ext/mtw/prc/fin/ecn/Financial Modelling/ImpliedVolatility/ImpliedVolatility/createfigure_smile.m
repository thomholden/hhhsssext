...
function createfigure_smile(x, y1, y2, y3,tit,legend1,legend2,legend3)
%CREATEFIGURE(X1,YMATRIX1)
%  x:  vector of xvalue data
%  y1,y2,y3:  vectors of densities yvalue data
%
% Used for the SABR model (since it is only for a fixed maturity!)
YMatrix1 = [y1; y2; y3];
...
plot1 = plot(x,YMatrix1,'LineWidth',1,'Color',[0 0 0],'Parent',axes1,...
    'MarkerSize',4);
set(plot1(1),'LineWidth',2,'MarkerSize',5,'DisplayName',legend1);
