% PURPOSE: An example using ginimap
%          to examine the gini density of
...
long = ohioschool(:,2);
latt = ohioschool(:,3);
income = ohioschool(:,31); % per capita income
scores = ohioschool(:,22); % proficiency scores

ginimap(long,latt,scores,[],[],1); % using points
