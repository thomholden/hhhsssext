function contplot(chmm,Xtrain,plotoptions)
%  contplot(chmm,Xtrain,plotoptions)
%
%   continous plotting of CHMM results
%


for c=1:chmm.NChains,
  Gamma=gethsbeliefs(chmm,c);% get weights
  X=cat(1,Xtrain(c).block(:).X);	% concat data 4 this chain
  singchacontplot(chmm.chain{c},X,Gamma,plotoptions(c,:));
end


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function singchacontplot(hmm,data,Gamma,plotoptions)
%  contplot(hmm,data,Gamma,plotoptions)
%
