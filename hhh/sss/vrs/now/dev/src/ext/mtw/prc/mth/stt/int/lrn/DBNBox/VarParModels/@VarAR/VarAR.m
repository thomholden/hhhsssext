function [obsmodel]=VarAR(varargin);
% [obsmodel]=VarAR(K,X,options);
% contructor for variational  Linear autoregessive observation model
%
...
defobsmodelstruct=struct('p',2,'Coeff_MvNorm_p',[],...
