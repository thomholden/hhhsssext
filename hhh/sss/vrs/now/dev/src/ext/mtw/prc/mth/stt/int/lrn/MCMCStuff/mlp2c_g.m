function [g, gdata, gprior] = mlp2c_g(w, net, p, t)
%MLP2C_G Evaluate gradient of error function for 2-layer softmax MLP.
%
%	Description
%	G = MLP2C_G(NET, P, T) takes a network data structure NET  together
...
%
%	[G, GDATA, GPRIOR] = MLP2C_G(NET, P, T) also returns separately  the
...
%
%	See also
%	MLP2, MLP2PAK, MLP2UNPAK, MLP2FWD, MLP2C_E, MLP2BKP
%
