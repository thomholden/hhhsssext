function opt = mlp2r_mcopt(opt);
% MLP2R_MCOPT  Default options for MLP2R_MC
%
%   Description
%   OPT = MLP2R_MCOPT(OPT) takes an options structure OPT and
...
if ~isfield(opt,'hmc_opt')
  ...
  opt.hmc_opt.stepsf='mlp2r_steps';
end
