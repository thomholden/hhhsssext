...
% Last Modified by GUIDE v2.5 18-Oct-2012 16:11:34
...
[grid_setup,reduction,corr_setup,FEM_setup,gridx,gridy,dispx,dispy,scale,...
    small_strain,large_strain,gridx_DU,gridy_DU,grid_setup_reduced,gridx_reduced,gridy_reduced,...
    corr_setup_reduced,dispx_reduced,dispy_reduced,gridx_def,gridy_def,...
    gridx_DU_def,gridy_DU_def] = load_computed_data;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%TEMPORARY!!!!!%%%%%%%%%%%%%%%%%%%%%%%%
% load disp_undistorted_data_radial
% dispx = dispx_undistorted;
% dispy = dispy_undistorted;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%TEMPORARY!!!!!%%%%%%%%%%%%%%%%%%%%%%%%
...
patch_contour_GUI_compatible(figpos,N_images_correlated,skip,grid_setup,...
...
param_disp_line_scan = disp_line_scan_GUI(N_images_correlated,N_pts,gridx,gridy,dispx,dispy,scale);
...
% Set the line scan parameters
param_disp_avg = disp_avg_GUI(N_images_correlated,N_pts,gridx,gridy,dispx,dispy,scale);
...
% Set the line scan parameters
param_dispgrad_line_scan = dispgrad_line_scan_GUI(computed_data);
