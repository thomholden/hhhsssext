...
for col=1:Nc %Column loop
  ...
  VF.kill=2;        %Enforcing stability by flipping unstable poles into left half plane
...
freq=s/(2*pi*i);
figure(3),
h1=semilogy(freq,abs(bigf).','c');hold on
h2=semilogy(freq,abs(bigfit).','m--');
