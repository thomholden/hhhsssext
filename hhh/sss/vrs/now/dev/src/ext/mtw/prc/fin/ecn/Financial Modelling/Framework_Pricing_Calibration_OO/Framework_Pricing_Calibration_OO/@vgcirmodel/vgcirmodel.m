...
classdef vgcirmodel < model
    ...
    properties (Constant = true)
        pname = 'VarianceGamma-CIR';
    end
    
    methods 
        function m = vgcirmodel(params)
            m.pnparams = 6;
    ...
    methods (Static)
        function phi = cf(u,T,t_star,r,d, params)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%% truncation of cosh,sinh,coth for numerical accuracy
            ...
            f2_u = repmat((kappa^2*eta*(T-t_star)/(lambda^2)),lenU,1)-log(y1 ...     
                +kappa*y2./gamma_u)*(2*kappa*eta*lambda^(-2));    
            ...
            if(t_star == 0)
                ...
                phi_tstar = kappa^2*eta*t_star*lambda^(-2)  + 2*y0*1i*psiX_i/(kappa+gamma_i*y3) ...
