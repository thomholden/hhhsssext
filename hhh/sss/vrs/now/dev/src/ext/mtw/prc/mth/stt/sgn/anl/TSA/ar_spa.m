...
%	$Revision: 1.13 $
% 	$Id: ar_spa.m,v 1.13 2006/04/12 13:04:38 schloegl Exp $
%	Copyright (C) 1996-2003,2006 by Alois Schloegl <a.schloegl@ieee.org>
...
% Remark: 
%    Sometimes the Power (i.e. real(F) ) can become negative!
