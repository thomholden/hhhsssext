function cond_N = checkOrthogonality(N, dirs, basisType, W)
%CHECKORTHOGONALITY  Computes the condition number for a least-squares SHT
%
...
%       case of a weighted least-squares
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
