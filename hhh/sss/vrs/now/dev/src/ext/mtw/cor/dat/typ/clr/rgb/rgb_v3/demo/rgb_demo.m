...
% mispell a color or the color you're thinking of is not in the database,
...
%% Installation
% Installation is simple.  Simply run |rgb_install.m|.  Run it once, it
% should take only a second or two to download and reformat the data. 
