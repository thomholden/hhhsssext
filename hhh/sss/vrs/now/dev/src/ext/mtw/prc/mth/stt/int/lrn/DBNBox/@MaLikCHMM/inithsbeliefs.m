function [chmm]=inithsbeliefs(chmm,Xtrain,T)
% [varargout]=inithsbeliefs(chmm,Xtrain,T) 
% 
% initialise hidden state variables in  CHMMs
% 
% INPUT
%
...
[chmm.chschain]=initbeliefs(chmm.chschain,B);
