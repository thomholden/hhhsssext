...
[parameters, LLF, EXITFLAG, OUTPUT, LAMBDA, GRAD] =  fmincon('fattailed_garchlikelihood2', startingvals ,sumA  , sumB ,[] , [] , LB , UB,[],options, data , p , q, errortype, stdEstimate, stdEstimate2, T, breakpt);
