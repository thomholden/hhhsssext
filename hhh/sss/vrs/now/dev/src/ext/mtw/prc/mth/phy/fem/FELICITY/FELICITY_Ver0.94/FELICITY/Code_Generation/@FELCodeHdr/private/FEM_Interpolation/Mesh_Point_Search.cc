...
inline void Project_Onto_Ref_Cell(VEC_2x1& PT, const double& TOL)
{
    ...
    if ( check_diag < 0.0 )
        {
        // shrink it back
        PT.v[0] = PT.v[0] + (0.5 + 1E-14) * check_diag;
        PT.v[1] = PT.v[1] + (0.5 + 1E-14) * check_diag;
        }
...
inline void Project_Onto_Ref_Cell(VEC_3x1& PT, const double& TOL)
{
    ...
    if ( check_diag < 0.0 )
        {
        // shrink it back
        PT.v[0] = PT.v[0] + ((1.0/3.0) + 1E-14) * check_diag;
        PT.v[1] = PT.v[1] + ((1.0/3.0) + 1E-14) * check_diag;
		PT.v[2] = PT.v[2] + ((1.0/3.0) + 1E-14) * check_diag;
        }
