...
% ====================================================================================================
%File description:
% We can run SGALAB by key-in "SGALAB_demo_MO_NSGA" in Matlab command window
%
%Input(1):
%            options[10]:
...
options = { 'Binary',
    ...
    '0',
    'NSGA', % will check in side SGA_entry_MO_Pareto_NSGA()
    'Goldberg',
    '1'};
...
[ maxfitness ,...
    ...
    best_decimal_space ,...
    best_coding_space ,...
    error_status ]= SGA__entry_MO_Pareto_NSGA...
    ( options,...
    min_confines ,...
    max_confines ,...
