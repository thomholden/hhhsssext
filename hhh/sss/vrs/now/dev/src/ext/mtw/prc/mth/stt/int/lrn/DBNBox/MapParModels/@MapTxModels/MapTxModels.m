function [txmodel]=MapTxModels(varargin);
% [txmodel]=MapTxModels(K,txmodeloptions,priors);
% contructor for maximum aposteriori state transition models 
%
