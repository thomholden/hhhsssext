...
%performGoalMining.m
%
%Used for mining with rule builder.  Control module to call different 
%functions to perfrom mining then calls displayRules to display the results

function performGoalMining(file_data,min_confidence,min_support,file_to_mine,LHS_goal,RHS_goal,sup_type,method_summary)
...
displayRules(ordered_rules,candidates,min_support,min_confidence,time_taken,file_to_mine,no_sets,method_summary);
