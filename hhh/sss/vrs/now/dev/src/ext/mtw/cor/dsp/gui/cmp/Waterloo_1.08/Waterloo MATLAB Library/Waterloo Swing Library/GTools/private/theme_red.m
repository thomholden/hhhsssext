...
if isempty(javaloaded)
    ...
    Defaults.put('Accordion.BannerBackground', '@GColor.getColor(''darkRed'')');
    Defaults.put('Accordion.TextColor', '@GColor.getColor(''MATLAB_lightGray'')');
    
    Defaults.put('TabDisplay.Panel','@javax.swing.JPanel()');
    Defaults.put('TabDisplay.Background', '@GColor.getColor(''darkRed'')');
    ...
    Defaults.put('Accordion.InnerBannerBackground','@java.awt.Color(0,0,0,0)');
    Defaults.put('Accordion.BannerBackground', '@java.awt.GradientPaint(0,0,GColor.getColor(''darkRed''),1,1,GColor.getColor(''lightRed''),true)');
    Defaults.put('Accordion.TextColor', '@GColor.getColor(''MATLAB_lightGray'')');
    
    Defaults.put('TabDisplay.Panel', '@kcl.waterloo.widgets.GJGradientPanel()');
    Defaults.put('TabDisplay.Background', '@java.awt.GradientPaint(0,0,GColor.getColor(''darkRed''),1,1,GColor.getColor(''lightRed''),true)');
    Defaults.put('TabDisplay.TextColor', '@GColor.getColor(''MATLAB_lightGray'')');
