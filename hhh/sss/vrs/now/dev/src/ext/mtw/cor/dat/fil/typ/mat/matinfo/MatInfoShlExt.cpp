// MatInfoShlExt.cpp : Implementation of CMatInfoShlExt
#include "stdafx.h"
#include "MatInfo.h"
...
HRESULT CMatInfoShlExt::Load ( LPCOLESTR wszFilename, DWORD dwMode )
{
...
HRESULT CMatInfoShlExt::GetInfoTip ( DWORD dwFlags, LPWSTR* ppwszTip )
{
    AFX_MANAGE_STATE(AfxGetStaticModuleState());    // init MFC
...
CString    sTooltip;
    ...
    sTooltip.Format ( _T("File size: %lu bytes\n"), dwFileSize );

    sTooltip += getMatFileSummary(m_sFilename);
