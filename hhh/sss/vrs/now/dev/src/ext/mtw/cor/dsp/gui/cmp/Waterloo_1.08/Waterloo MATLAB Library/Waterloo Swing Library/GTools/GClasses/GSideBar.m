classdef GSideBar < GFlyoutPanel
    ...
    methods
        ...
        function obj=GSideBar(target, point)
            ...
            try
                obj.Object=jcontrol(obj.Panel, org.jdesktop.swingx.JXPanel(), 'Position', [0 0 1 1]);
            catch
            ...
            set(obj.Rectangle, 'UserData', {obj.Panel, obj.Object, cp, obj.Point, obj.ComponentHeight});
            obj.Type='GSideBar';
            return
        end
