...
% Given an RGB colormap, a least-squares solver approximates the original
% Cubehelix colorscheme's parameter values, and returns these in a vector.
%
% Syntax:
...
% Note3: The search bounds are set to lb=[0,-20,0,0] and ub=[3,+20,3,3];
%
% See also CUBEHELIX CUBEHELIX_VIEW BREWERMAP RGBPLOT COLORMAP LSQNONLIN OPTIMSET
%
% ### Examples ###
%
...
%
% Inputs:
%  map = NumericMatrix, an RGB colormap of a Cubehelix colorscheme.
% Outputs:
