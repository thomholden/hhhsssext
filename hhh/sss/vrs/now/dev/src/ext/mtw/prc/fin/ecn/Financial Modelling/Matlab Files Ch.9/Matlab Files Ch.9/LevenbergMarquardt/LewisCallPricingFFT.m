...
function [call_price_fft, call_delta_fft,call_gamma_fft] = LewisCallPricingFFT(fftStruct,model,S,K,T,r,d)
...
FFT_N = fftStruct.N;% must be a power of two (2^14)
FFT_eta = fftStruct.eta; % spacing of psi integrand
