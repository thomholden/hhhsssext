...
%FVA: dirty hack to reduce label tick size
%fprintf('DeafaultTextFontSize=%d.\n',get(cax,'DefaultTextFontSize'))%FVA:
%It's actually 10pt
set(cax,'DefaultTextFontSize', 9);
