 ...
 * Usage:
 *
 * icpDVGpnt2pntLS(DATA,quality,quasirand,sizerand,randincreasing,maxiter,SURFDATA,normal,pdir,sdir,DVGdata,R,t)
 *
 * Input:
 *
...
#define	normal	prhs[7]
#define	pdir	prhs[8]
#define	sdir	prhs[9]
#define	DVGdata	prhs[10]


/* Output Arguments */

#define	rotationMatrixIO	prhs[11]
#define	transVecIO     prhs[12]
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray*prhs[]){
    ...
    icpDVGpnt2pntLS(mxGetPr(data), mxGetPr(quality), (unsigned int)mxGetN(data), (unsigned int*)mxGetPr(randvec), (unsigned int)mxGetScalar(sizerand), (unsigned int)mxGetScalar(randincrease), (unsigned int)mxGetScalar(maxiter), mxGetPr(surfdata), mxGetPr(normal), mxGetPr(pdir), mxGetPr(sdir), DVGdata, mxGetPr(rotationMatrixIO), mxGetPr(transVecIO));
