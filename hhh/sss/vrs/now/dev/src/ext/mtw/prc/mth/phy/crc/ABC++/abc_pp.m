...
global H_ABC_pp F_ABC_pp G_ABC_pp A_ABC_pp P_ABC_PP Timeseries Points C_ABC_pp c0
...
switch op
    ...
    case 0
        ...
        F_ABC_pp = figure('Color',back_clr, ...
	        'MenuBar','none', ...
	        'Name','ABC++ Piecewise Linear Non-linearity', ...
	        'NumberTitle','off', ...
            'Units','normalized', ...
        ...
        H_ABC_pp(6) = uicontrol('Parent',F_ABC_pp,'Style','pushbutton',... % Save Figure Button
            ...
            'String','Screenshot',...
            'Visible','on',...
            'CallBack','abc_pp(6)'); %Execute Switch Case 6 if pressed
        ...
        H_ABC_pp(100) = uicontrol('Parent',F_ABC_pp,'Style','pushbutton',... % Export Button
            ...
            'String','Export',...
            'Visible','on',...
            'CallBack','abc_pp(15)'); %Execute Switch Case 15 if pressed
        ...
        H_ABC_pp(212) = uicontrol('Parent',F_ABC_pp,'Style','pushbutton',... % Cubic
            'Units','normalized','Position',[0.838 0.467 0.055 0.03125],...
            'ForegroundColor',[0 0 0],...
            'FontWeight','bold',...
            'String','Cubic',...
            'Visible','off',...
    ...
    case 1
        ...
        if filename ~= 0 % Yes file exists
            ...
            set(F_ABC_pp,'Name',['ABC++ Piecewise Linear Non-linearity [',pathname,filename,']']);
            % Return to home dir
            cd(home);
            ...
            G_ABC_pp(9) = patch('Vertices',vertex_matrix,'Faces',[1 2 4 3],'EdgeColor','b','FaceColor','none','FaceAlpha',0.2,'EdgeAlpha',0.7);
            text(xlimit,ylimit,-sys_variables(7),'  U_{-1}','Color',[0 0 1],'FontWeight','bold');
            
            % Plot inner Plane
            if point_number ~= 1
                vertex_matrix = [point(1,:); point(2,:); -point(1,:); -point(2,:)];
                G_ABC_pp(8) = patch('Vertices',vertex_matrix,'Faces',[1 2 3 4],'EdgeColor',[ 0.000 0.502 0.502 ],'FaceColor','none','FaceAlpha',0.2,'EdgeAlpha',0.7);
                text(vertex_matrix(3,1),vertex_matrix(3,2),vertex_matrix(3,3),'  E^{c}(0)','Color',[ 0.000 0.502 0.502 ],'FontWeight','bold');
            end
            
            % Plot U Region Devision Planes
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            vertex_matrix = [-xlimit -ylimit sys_variables(7);-xlimit ylimit sys_variables(7);xlimit -ylimit sys_variables(7);xlimit ylimit sys_variables(7)];
            G_ABC_pp(5) = patch('Vertices',vertex_matrix,'Faces',[1 2 4 3],'EdgeColor','b','FaceColor','none','FaceAlpha',0.2,'EdgeAlpha',0.7);
            text(xlimit,ylimit,sys_variables(7),'  U_{1}','Color',[0 0 1],'FontWeight','bold');
            ...
            if point_number ~= 1
                ...
                G_ABC_pp(6) = patch('Vertices',vertex_matrix,'Faces',[1 2 3 4],'EdgeColor',[ 0.502 0.000 0.502 ],'FaceColor','none','FaceAlpha',0.2,'EdgeAlpha',0.7);
                text(vertex_matrix(4,1),vertex_matrix(4,2),vertex_matrix(4,3),'  E^{c}(P^{+})','Color',[ 0.502 0.000 0.502 ],'FontWeight','bold');
            ...
            if point_number ~= 1
                vertex_matrix = [point(1,:); point(2,:); mirror_point(1,:); mirror_point(2,:)];
                G_ABC_pp(7) = patch('Vertices',vertex_matrix,'Faces',[1 2 3 4],'EdgeColor',[ 0.502 0.000 0.502 ],'FaceColor','none','FaceAlpha',0.2,'EdgeAlpha',0.7);
                text(vertex_matrix(4,1),vertex_matrix(4,2),vertex_matrix(4,3),'  E^{c}(P^{-})','Color',[ 0.502 0.000 0.502 ],'FontWeight','bold');
    ...
    % Info Dialog
    case 2
        helpdlg(strvcat('James McEvoy, Tomás Uí Mhuirithe, Poincare Section by: Peadar Forbes, Keith O Donoghue','  ','Supervisor: Prof. Michael P Kennedy','  ','Adventures in Bifurication & Chaos using Matlab','  ','University College Cork 2003'),'Information');
    ...
    case 7     
        ...
        if point_number ~= 1
            vertex_matrix = [point(1,:); point(2,:); mirror_point(1,:); mirror_point(2,:)];
            G_ABC_pp(7) = patch('Vertices',vertex_matrix,'Faces',[1 2 3 4],'EdgeColor',[ 0.502 0.000 0.502 ],'FaceColor','none','FaceAlpha',0.5,'EdgeAlpha',0.7);
    ...
    case 10
        ...
        eigen_value = [str2double(get(A_ABC_pp(71),'String'))];
        savefile = 'data\temp.mat';
        save(savefile,'Timeseries','sys_variables','integ_variables','view_angle','eigen_value')
    ...
    case 11 
        ...
        if get(H_ABC_pp(13),'Value') == 1
            set(G_ABC_pp(6),'FaceColor',[ 0.502 0.000 0.502 ],'FaceAlpha',.2);
            set(G_ABC_pp(7),'FaceColor',[ 0.502 0.000 0.502 ],'FaceAlpha',.2);
            set(G_ABC_pp(8),'FaceColor',[ 0.000 0.502 0.502 ],'FaceAlpha',.2);
        else
...
case 12
    ...
    %Convert from a piecewise Linear to a cubic POPUP           
case 13
    
    back_clr = [0.7529 0.7929 0.97];
    % Figure
    c0 = figure('Color',[0.83137 0.81569 0.78431], ...
        'Color',back_clr, ...
        'Name','Convert to Cubic', ...
        'NumberTitle','off', ...
    ...
    % UI Aesthetics
    C_ABC_pp(1) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...  % Frame ()
        'Units','normalized','Position',[0.05 0.1 0.9 0.9],'Style','frame');
    
    C_ABC_pp(2) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...% Text
        'FontName','Helvetica','HorizontalAlignment','left',...
        'FontSize',10,'ForegroundColor',[0 0 0],...
        'Units','normalized','Position',[0.06 0.7 0.5 0.27],'String','Cubic Equation','Style','text');
    
    
    C_ABC_pp(3) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...% x coefficient input box 0.70 0.78 0.025 0.025
        'HorizontalAlignment','left','Units','normalized','Position',[0.08 0.5 0.1 0.23],'Style','edit','String','1');
    
    
    C_ABC_pp(5) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...% x coefficient text
        'FontName','Helvetica','HorizontalAlignment','left',...
        'FontSize',10,'ForegroundColor',[0 0 0],...
        'Units','normalized','Position',[0.18 0.5 0.1 0.23],'String','x^3+','Style','text');
    
    
    C_ABC_pp(6) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...% y coefficient input box
        'HorizontalAlignment','left','Units','normalized','Position',[0.35 0.5 0.1 0.23],'Style','edit','String','1');
    
    C_ABC_pp(7) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...% y coefficient text
        'FontName','Helvetica','HorizontalAlignment','left',...
        'FontSize',10,'ForegroundColor',[0 0 0],...
        'Units','normalized','Position',[0.40 0.5 0.1 0.23],'String','x^2+','Style','text');
    
    C_ABC_pp(8) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...% z coefficient input box
        'HorizontalAlignment','left','Units','normalized','Position',[0.50 0.5 0.1 0.23],'Style','edit','String','1');
    
    C_ABC_pp(9) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...% z coefficient text
        'FontName','Helvetica','HorizontalAlignment','left',...
        'FontSize',10,'ForegroundColor',[0 0 0],...
        'Units','normalized','Position',[0.60 0.5 0.1 0.23],'String','x+','Style','text');
    
    C_ABC_pp(10) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...% d coefficient input box
        'HorizontalAlignment','left','Units','normalized','Position',[0.70 0.5 0.1 0.23],'Style','edit','String','-.00137');
    
    C_ABC_pp(11) = uicontrol('Parent',c0,'BackgroundColor',[1 1 1],...% = 0 text
        'FontName','Helvetica','HorizontalAlignment','left',...
        'FontSize',10,'ForegroundColor',[0 0 0],...
        'Units','normalized','Position',[0.80 0.5 0.1 0.23],'String','= 0','Style','text');
    
    % Convert Button
    C_ABC_pp(4) = uicontrol('Parent',c0,'Style','pushbutton',... % Eigen Button
        'Units','normalized','Position',[0.28 0.18 0.5 0.3],...
        'ForegroundColor',[0 0 0],...
        'FontWeight','bold',...
        'String','Convert to Cubic',...
        'Visible','on',...
        'CallBack','abc_pp(14)');
...
case 14
    %Convert from a piecewise Linear to a cubic CALCULATIONS
    
    sys_variables = [str2double(get(A_ABC_pp(9),'String')),str2double(get(A_ABC_pp(8),'String')),str2double(get(A_ABC_pp(11),'String')),str2double(get(A_ABC_pp(10),'String')),str2double(get(A_ABC_pp(19),'String')),str2double(get(A_ABC_pp(20),'String')),str2double(get(A_ABC_pp(18),'String')),str2double(get(A_ABC_pp(12),'String'))]; % L,R0,C2,G,Ga,Gb,E,C1
    slope=[str2double(get(C_ABC_pp(3),'String')),str2double(get(C_ABC_pp(6),'String')),str2double(get(C_ABC_pp(8),'String')),str2double(get(C_ABC_pp(10),'String'))];
    
    convert_to_cubic(sys_variables,slope,A_ABC_pp);
...
case 15
 ...
 sys_variables = [str2double(get(A_ABC_pp(9),'String')),str2double(get(A_ABC_pp(8),'String')),str2double(get(A_ABC_pp(11),'String')),str2double(get(A_ABC_pp(10),'String')),str2double(get(A_ABC_pp(19),'String')),str2double(get(A_ABC_pp(20),'String')),str2double(get(A_ABC_pp(18),'String')),str2double(get(A_ABC_pp(12),'String'))]; % L,R0,C2,G,Ga,Gb,E,C1
        ...
        if point_number ~= 1
            vertex_matrix = [point(1,:); point(2,:); -point(1,:); -point(2,:)];
            G_ABC_pp(8) = patch('Vertices',vertex_matrix,'Faces',[1 2 3 4],'EdgeColor',[ 0.000 0.502 0.502 ],'FaceColor',[ 0.000 0.502 0.502 ],'FaceAlpha',0.2,'EdgeAlpha',0.7);
            text(vertex_matrix(3,1),vertex_matrix(3,2),vertex_matrix(3,3),'  E^{c}(0)','Color',[ 0.000 0.502 0.502 ],'FontWeight','bold');
        end
        ...
        if point_number ~= 1
            vertex_matrix = [point(1,:); point(2,:); mirror_point(1,:); mirror_point(2,:)];
            G_ABC_pp(6) = patch('Vertices',vertex_matrix,'Faces',[1 2 3 4],'EdgeColor',[ 0.502 0.000 0.502 ],'FaceColor',[ 0.502 0.000 0.502 ],'FaceAlpha',0.2,'EdgeAlpha',0.7);
            text(vertex_matrix(4,1),vertex_matrix(4,2),vertex_matrix(4,3),'  E^{c}(P^{+})','Color',[ 0.502 0.000 0.502 ],'FontWeight','bold');
        ...
        if point_number ~= 1
            vertex_matrix = [point(1,:); point(2,:); mirror_point(1,:); mirror_point(2,:)];
            G_ABC_pp(7) = patch('Vertices',vertex_matrix,'Faces',[1 2 3 4],'EdgeColor',[ 0.502 0.000 0.502 ],'FaceColor',[ 0.502 0.000 0.502 ],'FaceAlpha',.2,'EdgeAlpha',0.7);
...
function f=convert_to_cubic(sys_variables,slope,A_ABC_pp)
...
%Save these new parameters to file
home = pwd;
        cd('data');
        [filename, pathname, filterindex] = uiputfile( ...
            {
        ...
        if filename ~= 0 % Yes Save figure
            ...
            file_contents=[get(A_ABC_pp(28),'String'),',',get(A_ABC_pp(27),'String'),', 0, -1,',num2str(L),',',num2str(R0),',',num2str(C2),',',num2str(G),',',num2str(Ga),',',num2str(Gb),',',num2str(E),',',num2str(C1),',',get(A_ABC_pp(74),'String'),',',get(A_ABC_pp(21),'String'),',',get(A_ABC_pp(22),'String'),',',get(A_ABC_pp(23),'String'),',',get(A_ABC_pp(53),'String'),',',get(A_ABC_pp(44),'String'),',',get(A_ABC_pp(47),'String'),',',get(A_ABC_pp(50),'String'),',',get(A_ABC_pp(6),'String'),',',get(A_ABC_pp(7),'String'),',',num2str(slope(1)),',',num2str(slope(2)),',',num2str(slope(3)),',',num2str(slope(4)),',"',get(A_ABC_pp(120),'String'),'"'];
            file_routine('write',[filename,'.',extension],file_contents);
...
function f = dp_popup(R0,Ga,Gb,G)
