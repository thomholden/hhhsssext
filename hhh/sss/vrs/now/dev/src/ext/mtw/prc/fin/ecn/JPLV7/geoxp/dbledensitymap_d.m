% PURPOSE: An example using dbledensitymap
%          to examine the density of
%          a vector-variable over a map
%---------------------------------------------------
% USAGE: dbledensitymap_d
%---------------------------------------------------
...
spending = ohioschool(:,10); % per pupil spending on instruction

a1 = 30; % density bandwidth parameters
a2 = 10;
dbledensitymap(long,latt,scores,spending,a1,a2,[],[],1); % using points
