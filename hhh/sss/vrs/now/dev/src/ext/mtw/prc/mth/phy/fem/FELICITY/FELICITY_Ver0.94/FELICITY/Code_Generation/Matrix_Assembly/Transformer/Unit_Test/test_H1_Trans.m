...
Func_f( 3).Code = myFUNC.FUNC_d_ds_C_Code;
Func_f( 4).Code = myFUNC.FUNC_Grad_C_Code;
Func_f( 5).Code = myFUNC.COEF_FUNC_Val_C_Code;
Func_f( 6).Code = myFUNC.COEF_FUNC_d_ds_C_Code;
Func_f( 7).Code = myFUNC.COEF_FUNC_Grad_C_Code;
