function drawarrow(x1,x2,y1,y2,len,color)
...
hdl_line=line(x,y,'color',color); % you can change the color of line here,default color is black
p1_x=x2;
p1_y=y2;
...
hdl_head=patch([p1_x p2_x p3_x],[p1_y p2_y p3_y],color); % you can change the color of arrow here,default color is black