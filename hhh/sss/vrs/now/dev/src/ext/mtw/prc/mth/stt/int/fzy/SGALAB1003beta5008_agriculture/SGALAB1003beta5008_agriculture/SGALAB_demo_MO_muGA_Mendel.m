% /*M-FILE SCRIPT SGALAB_demo_MO_muGA_mendel MMM SGALAB */ %
% /*==================================================================================================
...
%
%Usage:
%  We can run SGALAB by key-in "SGALAB_demo_MO_muGA_mendel" in Matlab command
%  window
%===================================================================================================
...
% SGALAB_demo_MO_muGA_mendel Begin
...
fid18 = fopen('INPUT_mendel_number_percent.txt','r');
...
mendel_number_percent = fscanf(fid18,'%g'); % [0,1], percent of mendel number
...
options = { 'Binary',
    %     'Roulettewheel',
    'tournament',
    '2',% 2 points crossover, uniformly distributed
    '2',% 2 points mutation , uniformly distributed
    '0',
...
[ maxfitness ,...
    ...
    best_decimal_space ,...
    best_coding_space ,...
    error_status ]= SGA__entry_MO_Pareto_muGA_mendel...
    ( options,...
    min_confines ,...
    max_confines ,...
...
toc
clear all
% SGALAB_demo_MO_muGA_mendel End
