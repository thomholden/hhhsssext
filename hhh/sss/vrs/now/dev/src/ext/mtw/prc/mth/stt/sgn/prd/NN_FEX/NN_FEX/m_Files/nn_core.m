...
switch method
    case 'correlation'
        ...
        chunk = x(n1-m+1:n1,1);
        mcorrel = zeros(n1-m,1);
        for i = 0:(n1-m-1)
            aba = corrcoef(chunk,x(n1-m-i:n1-i-1,1));
            mcorrel(n1-m-i) = aba(2,1);
        end
