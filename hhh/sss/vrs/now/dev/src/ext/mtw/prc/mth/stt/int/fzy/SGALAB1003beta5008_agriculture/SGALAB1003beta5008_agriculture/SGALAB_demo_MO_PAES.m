% /*M-FILE SCRIPT SGALAB_demo_MO_PAES MMM SGALAB */ %
% /*==================================================================================================
...
% ====================================================================================================
%File description:
% We can run SGALAB by key-in "SGALAB_demo_MO_PAES" in Matlab command window
%
%Input(1):
%            options[10]:
...
disp('');
disp('    18-Mar-2006 Chen Yi update 1003  Beta4   chenyi2005@gmail.com  Shanghai ')
disp('/*==================================================================================================*/')
disp('>>>>')
...
[ maxfitness ,...
  ...
  best_decimal_space ,...
  best_coding_space ,...
  error_status ]= SGA_entry_MO_Pareto_PAES...      
( options,...
  min_confines ,...
  max_confines ,...
