...
% Kienitz, Wetterau, 2010
% Bugfix with the even and odd numbers used for integration
% we found since the CMS Caplet prices computed in Chapter 4 were not
% as expected but the difference was small!!!
