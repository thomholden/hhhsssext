 ...
 * $Revision: 1.1.6.2 $ $Date: 2012/05/15 14:24:24 $
 */ 
...
void LibCreate_FromMMFile(void *hl, char *warn, const char *fileName, const char *pluginPaths, const char* arConverterPath,
                          ...
                          unsigned char scaledDoubleAudio, unsigned char scaledDoubleVideo) 
{
    ...
    *hostLib->errorMessage  = '\0';
    if(warn)
        *warn = '\0';
    hostLib->instance = (MAKE_FCN_PTR(pFnLibCreate_FromMMFile,hostLib->libCreate))(hostLib->errorMessage, warn, fileName, pluginPaths, arConverterPath,
                                                                                   (MMAudioInfo*) aInfo, (MMVideoInfo*) vInfo,
                                                                                   numRepeats, loopIndef, (FourCCType)fourcc, scaledDoubleAudio, scaledDoubleVideo);
}
...
void LibCreate_ToMMFile(void *hl, char *warn, const char *fileName, int fileType,
                        void *aInfo, void *vInfo,
                        unsigned char scaledDoubleAudio, unsigned char scaledDoubleVideo,
                        char* awPluginPath, char* awConverterPath, char* awFilterPath)
{
    ...
    *hostLib->errorMessage  = '\0';
    if(warn)
        *warn = '\0';
    hostLib->instance = (MAKE_FCN_PTR(pFnLibCreate_ToMMFile,hostLib->libCreate))(hostLib->errorMessage, warn, fileName, (MMFileType) fileType,
                                                                                 (MMAudioInfo*) aInfo, (MMVideoInfo*) vInfo,
