function contplot(mix,data,plotoptions)
%  contplot(mix,data,plotoptions)
%
%   continous plotting of Mixture Model results
%
...
if (dpf | cpf),
  ...
  for k=1:mix.K,
    if ndim>1
      ...
      centre=getmean(mix.obsmodel{k});
      Cov=getvar(mix.obsmodel{k});
