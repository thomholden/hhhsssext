function [hmm]=MaLikHMM(varargin);
% [hmm]=MaLikHMM(K,X,obsmodel,options);
%       or
% [hmm]=MaLikHMM(K,X,obsmodel,options,Y,outlmodel,outloptions);
%
...
deftrain=struct('cyc',100,'debug',0,'inftype',hsinfmodes{1}, ...
		...
		'rdisplay',1,'plot',0,'phtime',.1,'tol',1e-7);
