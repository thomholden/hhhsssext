...
if (~isempty(SQEString))
   ...
   if ~(get(hSQ,'Value'))
      invoke(hDB.QueryDefs,'Delete',SQEString);
   else
...
clear data hWait FLDName hFLD hRSet i j status
