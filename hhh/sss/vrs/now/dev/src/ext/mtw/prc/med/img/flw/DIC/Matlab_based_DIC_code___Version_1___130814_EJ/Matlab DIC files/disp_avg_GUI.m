...
% Last Modified by GUIDE v2.5 01-Jul-2013 16:23:05
...
elseif yn_avg_line_scan == 1
    ...
    if isempty(grid_location)
        ...
        plot_title = {[plot_title_data,' averaged over'];[plot_title_dir,' line ',plot_title_location,' from the ',plot_title_ROI_boundary,' of the image']};
    end
