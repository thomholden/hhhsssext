...
classdef optfmincon < optgeneticbase
    properties
        % from defintion of base class
        S_struct = [];
    ...
    methods (Access = 'public')
        function ocm = optfmincon(S_struct,objfhandle,constfhandle)
        ...
        function [x, f] = optimize(ocm)
            [x, f] = fmincon(ocm.objfunc,ocm.S_struct.start, [], [], [], [], ocm.S_struct.lb, ocm.S_struct.ub,ocm.constfunc,ocm.options);
        end     
    end
