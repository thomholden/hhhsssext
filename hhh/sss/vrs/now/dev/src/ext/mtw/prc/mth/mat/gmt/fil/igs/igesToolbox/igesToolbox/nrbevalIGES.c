...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (mxGetM(parametervalues)==2){
        ...
        if(nlhs==1 && nrhs==2){
            ...
            NURBSsurfaceEval(orderU-1, orderV-1, mxGetPr(mxGetField(nurbsstructure, 0, "coefs")), ncp, kcp, mxGetPr(mxGetCell(mxGetField(nurbsstructure, 0, "knots"), 0)), mxGetPr(mxGetCell(mxGetField(nurbsstructure, 0, "knots"), 1)), mxGetPr(parametervalues), (int)mxGetN(parametervalues), mxGetPr(evaluated_points), leftU, rightU, NU, leftV, rightV, NV);
            ...
            BspEval2(orderU-1, orderV-1, mxGetPr(mxGetField(nurbsstructure, 0, "coefs")), 4, ncp, kcp, mxGetPr(mxGetCell(mxGetField(nurbsstructure, 0, "knots"), 0)), mxGetPr(mxGetCell(mxGetField(nurbsstructure, 0, "knots"), 1)), mxGetPr(parametervalues), (int)mxGetN(parametervalues), bspPnts, leftU, rightU, NU, leftV, rightV, NV);
            evaluated_points = mxCreateDoubleMatrix(3, (int)mxGetN(parametervalues), mxREAL);
        ...
        if(nlhs==1 && nrhs==2){
            ...
            if(nlhs>1 && nrhs>2){
                ...
                BspEval(orderU-2, mxGetPr(mxGetField(dnurbsstructure, 0, "coefs")), 4, (int)mxGetN(mxGetField(dnurbsstructure, 0, "coefs")), mxGetPr(mxGetField(dnurbsstructure, 0, "knots")), mxGetPr(parametervalues), (int)mxGetN(parametervalues), bspPnts, left, right, N);
                weights = (double*) malloc((mxGetN(parametervalues))*sizeof(double)+1);
                for (j = 0; j < mxGetN(parametervalues); j++){
                    weights[j]=bspPnts[4*j+3];
                }
                ...
                if(nlhs>2 && nrhs==4){
                    ...
                    if (orderU>2){
                        BspEval(orderU-3, mxGetPr(mxGetField(d2nurbsstructure, 0, "coefs")), 4, (int)mxGetN(mxGetField(d2nurbsstructure, 0, "coefs")), mxGetPr(mxGetField(d2nurbsstructure, 0, "knots")), mxGetPr(parametervalues), (int)mxGetN(parametervalues), bspPnts, left, right, N);
                        for (j = 0; j < mxGetN(parametervalues); j++){
                            for (i = 0; i < 3; i++){
