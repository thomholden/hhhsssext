...
% % integers (0).  The default is to remove duplicates, no_duplicates=1.  
% % If duplicates are removed, then each integer can occur only once.
% % no_duplicates=1; means to remove all duplicates.
% % no_duplicates=0; means to keep all duplicates.
% % 
...
% sorted=0;
% no_duplicates=0; % keep all duplicates
% [ndraw, count, count2]=rand_int(a,b,n, sorted, no_duplicates, make_plot);
% 
...
% %
% % modified   21 December  2013    Updated Comments.
% %
% %
% % **********************************************************************
% %
...
% flag = 1 means the output must be truncated because of bad input
flag=0;
