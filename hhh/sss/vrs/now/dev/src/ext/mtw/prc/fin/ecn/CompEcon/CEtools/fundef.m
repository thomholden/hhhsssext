...
%   and error is encountered. The second syntax sets g=[] and returns an
%   error message if an error in encountered, otherwise it returns a 
%   funciton definition structure and an empty string (test using if isempty(errorstr)).
%
...
%  degree of the polynomial (1 plus its order), and a and b, the right and left endpoints.
%
% Examples:
