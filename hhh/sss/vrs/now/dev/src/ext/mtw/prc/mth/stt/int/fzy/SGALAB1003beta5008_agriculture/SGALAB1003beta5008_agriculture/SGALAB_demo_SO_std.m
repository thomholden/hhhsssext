% /*M-FILE SCRIPT SGALAB_demo_SO_std MMM SGALAB */ %
% /*==================================================================================================
...
% ====================================================================================================
% File description:
% We can run SGALAB by key-in "SGALAB_demo_SO_std" in Matlab command window
%
%Input(1):
%            options[10]:
...
[ fitness_data ,...
  ...
  best_decimal_space ,...
  best_coding_space ,...
  error_status ]= SGA__entry_SO_std...      
( options,...
  min_confines ,...
  max_confines ,...
