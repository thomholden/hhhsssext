...
if (min(isfield(MAP1_test.PHI,{'Mesh_Size','Val','Grad','Metric','Det_Metric','Inv_Det_Metric','Inv_Metric',...
                     ...
                     'Hess','Inv_Hess','Second_Fund_Form','Det_Second_Fund_Form','Inv_Det_Second_Fund_Form',...
                     'Total_Curvature_Vector','Total_Curvature','Gauss_Curvature'}))==0)
    status = 1;
end
...
if ~isempty(myMAP.PHI.Inv_Hess)
    TF = false; % this has not been implemented
end
...
Map_PHI(16).Code = myMAP.PHI_2nd_Fund_Form_C_Code;
Map_PHI(17).Code = myMAP.PHI_Det_2nd_Fund_Form_C_Code;
Map_PHI(18).Code = myMAP.PHI_Inv_Det_2nd_Fund_Form_C_Code;
Map_PHI(19).Code = myMAP.PHI_Total_Curvature_Vector_C_Code;
Map_PHI(20).Code = myMAP.PHI_Total_Curvature_C_Code;
Map_PHI(21).Code = myMAP.PHI_Gauss_Curvature_C_Code;
