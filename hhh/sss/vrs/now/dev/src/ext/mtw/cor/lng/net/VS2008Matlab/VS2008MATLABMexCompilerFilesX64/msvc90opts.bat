...
set PATH=%VCINSTALLDIR%\BIN\;C:\Program Files\Microsoft SDKs\Windows\v6.0A\bin;%VSINSTALLDIR%\Common7\IDE;%VSINSTALLDIR%\SDK\v3.5\bin;%VSINSTALLDIR%\Common7\Tools;%VCINSTALLDIR%\VCPackages;%MATLAB_BIN%;%PATH%
