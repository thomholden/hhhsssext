function [hmm]=VarHMM(varargin);
% [hmm]=VarHMM(K,X,obsmodel,options);
%       or
% [hmm]=VarHMM(K,X,obsmodel,options,Y,outlmodel,outloptions);
%
% contructor for variational hidden markov models 
%
