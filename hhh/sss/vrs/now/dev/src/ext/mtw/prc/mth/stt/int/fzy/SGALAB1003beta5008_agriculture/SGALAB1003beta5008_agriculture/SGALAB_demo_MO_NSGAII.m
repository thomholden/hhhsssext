...
% ====================================================================================================
%File description:
% We can run SGALAB by key-in "SGALAB_demo_MO_NSGAII" in Matlab command window
%
%Input(1):
%            options[10]:
...
options = { 'binary',
    %              'tournament',
    'Roulettewheel',
    '1' % 1 point crossover, uniformly distributed
    '1',% 1 point mutation , uniformly distributed
    '0', % without constraints
    'NSGAII',  % will check in side SGA_entry_MO_Pareto_NSGAII()
    'Goldberg',
    '1'};
...
[ maxfitness ,...
    ...
    best_decimal_space ,...
    best_coding_space ,...
    error_status ]= SGA__entry_MO_Pareto_NSGAII...
    ( options,...
    min_confines ,...
    max_confines ,...
