...
% ====================================================================================================
%File description:
% We can run SGALAB by key-in "SGALAB_demo_MO_NPGA" in Matlab command window
%
%Input(1):
%            options[10]:
...
options = { 'Binary',
    ...
    '0',
    'NPGA',  % will check inside SGA_entry_MO_Pareto_NPGA()
    'Goldberg',
    '1'};
...
[ maxfitness ,...
    ...
    best_decimal_space ,...
    best_coding_space ,...
    error_status ]= SGA__entry_MO_Pareto_NPGA...
    ( options,...
    min_confines ,...
    max_confines ,...
