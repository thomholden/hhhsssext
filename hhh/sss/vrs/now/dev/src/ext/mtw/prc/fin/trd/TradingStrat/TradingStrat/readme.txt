...
* If the MCR is not installed, run MCRInstaller, located in:
  ...
  /Applications/MATLAB_R2009b.app/toolbox/compiler/deploy/maci64/MCRInstaller.dmg
...
================================
-runCSV 
-run_runCSV.sh (shell script run to
                             temporarily set environment variables
                             and execute the application)
-MCRInstaller.dmg 
   -include when building component by selecting "include MCR" option 
    in deploytool
-The Macintosh bundle directory structure runCSV.app 
   -this can be gathered up using the zip command 
    zip -ry runCSV.zip runCSV.app
    or the tar command 
    tar -cvf runCSV.tar runCSV.app
-This read-me file 
     ...
     ii. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_runCSV.sh 
